...
namespace tve {
	...
	void TvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
	{
		...
		// describes the transformation between pipeline output and target img
		...
		// rasterization stage -> breaks up geometry into fragments for overlapping triangles
		...
		// how rasterizer handles edges of geometry -> MSAA
		...
		// how colors are combined in framebuffer
		...
		// depth value to whatever fragment is on top for a pixel
